...
export interface Album {
  ...
  mediaCount: number
  media: MediaItem[]
  // Color dominante extraído de la portada (HSL)
  dominantColor: { h: number; s: number; l: number }
}

// Datos de ejemplo con colores dominantes basados en las imágenes
export const albums: Album[] = [
  {
    ...
    mediaCount: 24,
    dominantColor: { h: 90, s: 50, l: 55 }, // Verde fresco
    media: [
  ...
  },
  {
    ...
    mediaCount: 45,
    dominantColor: { h: 195, s: 65, l: 45 }, // Azul turquesa del mar
    media: [
  ...
  },
  {
    ...
    mediaCount: 22,
    dominantColor: { h: 20, s: 45, l: 38 }, // Cálido y acogedor
    media: [
  ...
  },
  {
    ...
    mediaCount: 18,
    dominantColor: { h: 45, s: 60, l: 50 }, // Amarillo cálido
    media: [
  ...
  },
  {
    ...
    mediaCount: 156,
    dominantColor: { h: 30, s: 45, l: 65 }, // Dorado suave
    media: [
  ...
  },
  {
    ...
    mediaCount: 30,
    dominantColor: { h: 170, s: 55, l: 42 }, // Verde fresco
    media: [
  ...
  },
  {
    ...
    mediaCount: 67,
    dominantColor: { h: 210, s: 35, l: 40 }, // Azul montaña
    media: [
  ...
  },
  {
    ...
    mediaCount: 41,
    dominantColor: { h: 25, s: 55, l: 40 }, // Marrón asado
    media: [
...
export const years = [...new Set(albums.map(a => a.year))].sort((a, b) => b - a)
