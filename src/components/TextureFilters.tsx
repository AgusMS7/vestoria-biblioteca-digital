export function TextureFilters() {
  return (
    ...
    >
      <defs>
        {/* Wood grain: stretched turbulence simulates organic walnut grain */}
        ...
        {/* Wood grain dark variant: slightly different seed and frequency */}
        ...
        {/* Shelf wood grain: more horizontal stretch, lighter */}
        ...
        {/* Paper grain: fine, even noise — like paper fibers */}
        ...
        {/* Paper tonal variation: very broad, slow shifts */}
